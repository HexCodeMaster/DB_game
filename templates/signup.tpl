                ...
                <div class="row">
                        ...
                        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                            ...
                            <form method="post" action="includes/signup.inc.php">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" id="form2Example18" class="form-control form-control-lg" name="user_id" />
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" id="form2Example20" class="form-control form-control-lg" name="username" placeholder="mamba_007" />
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="password" id="form2Example22" class="form-control form-control-lg" name="pwdRepeat" />
                                </div>

                                <div class="pt-1 mb-4">
                                    <button class="btn btn-info btn-lg btn-block" name="submit" type="submit">Sign Up</button>
                                </div>
                    ...
                    <div class="col-sm-6 px-0 d-none d-sm-block">
                        <img src="./templates/img/1_TaP1efuIeZcIRkZpxVIjRg.png"
                             alt="Login image" class="w-200 vh-100" id="b52"  style="object-fit: cover; object-position: left;">
                    </div>
                </div>
            </div>
        </section>

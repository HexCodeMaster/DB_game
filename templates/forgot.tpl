        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=startGameForm">Start Game</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-sm-6 text-black">
                        ...
                        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                                ...
                                <form style="width: 23rem;" action="reset-password.php" method="post">

                                    <h3 class="text-muted mb-3 pb-3" style="letter-spacing: 1px;">Reset Password</h3>

                                    <div class="form-outline mb-4">
                                        <label class="text-muted" for="email">Email address</label>
                                        <input type="email" id="email" class="form-control form-control-lg" name="userEmail" required/>
                                    </div>
                                    ...
                                    <div class="form-muted mb-4">
                                        <label class="text-muted" for="confirmPassword">Confirm New Password</label>
